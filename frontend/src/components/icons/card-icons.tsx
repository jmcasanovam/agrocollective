...
export function CloudSunIcon({ className = base }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BrainIcon({ className = base }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M12 5a3 3 0 1 0-5.997.125A4 4 0 0 0 3 9v1a3 3 0 0 0 0 6 4 4 0 0 0 4 4h1a3 3 0 0 0 4-3" />
      <path d="M12 5a3 3 0 1 1 5.997.125A4 4 0 0 1 21 9v1a3 3 0 0 1 0 6 4 4 0 0 1-4 4h-1a3 3 0 0 1-4-3" />
      <path d="M12 5v14" />
    </svg>
  );
}
...
export function LightbulbIcon({ className = base }: IconProps) {
  return (
    ...
    >
      <path d="M9 18h6" />
      <path d="M10 22h4" />
      <path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.6.65 1.15 1.42 1.41 2.5" />
    </svg>
  );
}
